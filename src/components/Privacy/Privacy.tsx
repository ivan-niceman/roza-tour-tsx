  ...
  return (
    <div className="main__privacy container">
      ...
      <p>
        ...
        безопасности персональных данных, предпринимаемые ООО РОЗА-ТУР (далее –
        Оператор).
      </p>
      <p>
      ...
      <p>
        ...
        сети интернет по сетевому адресу https://www.rozatour.ru/.
      </p>
      <p>
      ...
      <p>
        ...
        материалам, содержащимся на веб-сайте https://www.rozatour.ru/.
      </p>
      <p>
        ...
        почты roza-tur31@rambler.ru с пометкой «Отказ от уведомлений о новых
      ...
      <p>
        ...
        специальные формы, расположенные на сайте https://www.rozatour.ru/ или
      ...
      <p>
        ...
        уведомление на адрес электронной почты Оператора roza-tur31@rambler.ru с
      ...
      <p>
        ...
        электронный адрес Оператора roza-tur31@rambler.ru с пометкой «Отзыв
      ...
      <p>
        ...
        Оператору с помощью электронной почты roza-tur31@rambler.ru.
      </p>
      <p>
      ...
      <p>
        ...
        Интернет по адресу https://www.rozatour.ru/.
      </p>
    </div>
  );
}
